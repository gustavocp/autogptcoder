...
# ==================== CONFIGURAÇÕES ====================
CONFIG = {
    "llm_url": "http://localhost:1234/v1/completions",  # URL da API do LLM (LM Studio)
    ...
    "max_tokens": 1000,       # Pode aumentar para 10k conforme necessário
    "temperature": 0.7,
    "max_iterations": 10,
    "save_folder": "tests",
...
def detect_language(code):
    """
    Detecta se o código é Python ou JavaScript.
    """
