...
def build_generation_prompt(iteration, goal, last_code, last_error):
    if iteration == 0:
        ...
        return (
            ...
            "Retorne apenas o código corrigido, sem incluir mensagens de erro ou comentários extras."
        )
...
def auto_gpt_loop(goal, max_iterations):
    ...
    while iteration < max_iterations:
        ...
        last_tested_code = code  # Armazena somente o código
        ...
        if success:
            ...
            write_log(error_msg, log_list)
            yield error_msg
        last_error_output = output  # Armazena somente o erro
        ...
        correction_prompt = (
            f"O seguinte código apresentou os seguintes erros:\n\n"
            f"Último código gerado:\n{last_tested_code}\n\n"
            f"Erro:\n{last_error_output}\n\n"
            f"Objetivo inicial: {goal}\n\n"
            "Corrija o código e retorne apenas o código corrigido, sem incluir a mensagem de erro ou comentários extras."
        )
